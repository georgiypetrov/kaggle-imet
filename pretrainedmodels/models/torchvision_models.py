...
model_urls = {
    ...
    'densenet121': 'http://data.lip6.fr/cadene/pretrainedmodels/densenet121.pth',
    'densenet169': 'http://data.lip6.fr/cadene/pretrainedmodels/densenet169.pth',
    'densenet201': 'http://data.lip6.fr/cadene/pretrainedmodels/densenet201.pth',
    'densenet161': 'http://data.lip6.fr/cadene/pretrainedmodels/densenet161.pth',
    'inceptionv3': 'https://download.pytorch.org/models/inception_v3_google.pth',
    'resnet18': 'https://download.pytorch.org/models/resnet18.pth',
    'resnet34': 'https://download.pytorch.org/models/resnet34.pth',
    'resnet50': 'https://download.pytorch.org/models/resnet50.pth',
    'resnet101': 'https://download.pytorch.org/models/resnet101.pth',
    'resnet152': 'https://download.pytorch.org/models/resnet152.pth',
    'squeezenet1_0': 'https://download.pytorch.org/models/squeezenet1_0.pth',
    'squeezenet1_1': 'https://download.pytorch.org/models/squeezenet1_1.pth',
    'vgg11': 'https://download.pytorch.org/models/vgg11.pth',
    'vgg13': 'https://download.pytorch.org/models/vgg13.pth',
    'vgg16': 'https://download.pytorch.org/models/vgg16.pth',
    'vgg19': 'https://download.pytorch.org/models/vgg19.pth',
    'vgg11_bn': 'https://download.pytorch.org/models/vgg11_bn.pth',
    'vgg13_bn': 'https://download.pytorch.org/models/vgg13_bn.pth',
    'vgg16_bn': 'https://download.pytorch.org/models/vgg16_bn.pth',
    'vgg19_bn': 'https://download.pytorch.org/models/vgg19_bn.pth',
